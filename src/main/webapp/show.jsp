            ...
            <fieldset>
                ...
                <form action="saveEdits.jsp" method = "post">
                    <table>
                        ...
                        <!-- ready only Other rows -->
                        <tr style='background: white;'>
                            <td>
                                <label for="description">Description:</label>
                            </td>
                            <td>
                                <input id = "description" name="description" style="font-size:16px" value="${listStuff.rows[0].description}" type='text' readonly />
                            </td>
                        </tr>
                        <!-- last row, cost row, readonly -->
                        <tr style="background:white">
                            <td>
                                <label for="cost">Cost</label>
                            </td>
                            <td>
                                <input id="cost" name="cost" style='font-size:16px' value='${listStuff.rows[0].cost}' type='number' readonly />
                            </td>
                        </tr>
                        <!-- end of the rows -->
                    </table>
                            
                            <p><a href="${pageContext.request.contextPath}/expenses.jsp" />Back | 
